...
# export GENERATED_TEXT_FILE=../output/dialog/philly_dailydialog_epoch_25.0_beta_1.0/eval_text_generation_results.txt
...
CUDA_VISIBLE_DEVICES=$GPU_ID python examples/big_ae/run_spacefusion_pretraining.py \
    ...
    --sents_per_cxt 10 \
    --eval_generated_text_file $GENERATED_TEXT_FILE\
    --checkpoint_dir ../output/dialog/local-dialog-switchboard \
